...
func (d *Driver) VolumePath(logger lager.Logger, id string) (string, error) {
	volPath := filepath.Join(d.storePath, d.VolumesDirName, id)
...
func (d *Driver) WriteVolumeMeta(logger lager.Logger, id string, metadata imagepuller.VolumeMeta) error {
